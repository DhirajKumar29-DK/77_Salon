    ...
    <section className="py-16 sm:py-20 bg-[#0a1a3f] text-[#f8fafc] border-t border-[#d4af37]/25">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          title="Bespoke Hair Health & Architecture."
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="group bg-[#0f2352]/70 border border-[#d4af37]/35 flex flex-col justify-between shadow-xl hover:border-[#d4af37] transition-all rounded-lg overflow-hidden">
